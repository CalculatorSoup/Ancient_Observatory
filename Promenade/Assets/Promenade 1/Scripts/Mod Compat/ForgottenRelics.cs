...
namespace Promenade
{
    public class ForgottenRelicsCompat
    {
        ...
        public static void AddEnemies()
        {
            ...
            if (Promenade.toggleBrassMonolith.Value && !FRCSharp.VF2ConfigManager.disableBrassMonolith.Value)
            {
                ...
                DirectorAPI.Helpers.AddNewMonsterToStage(MonolithHolder, false, DirectorAPI.Stage.Custom, "observatory_wormsworms");
                DirectorAPI.Helpers.AddNewMonsterToStage(MonolithHolder, false, DirectorAPI.Stage.Custom, "itobservatory_wormsworms");
